#Xander Nuttle
#mrmip_pb7i_dm_fastq.sh
#Call: bsub -sla miket_sc -q long -R 'hname!=ib024 && hname!=ib028 && hname!=ib031 && hname!=cmu103 && hname!=cmu105 && hname!=cmu234' -J mrmip_pb7i_dm_fastq < /data/talkowski/xander/MIPs/analysis_programs/mrmip_pb7i_dm_fastq.sh
#
#The script automates the MIP analysis pipeline for genotyping for use in analyzing data from PB megapool 7i, with
...
taglength=8
genome=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/PB_indels_tagged.fasta
gsize=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/PB_indels_tagged.fasta.fai
miptargets=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/PB_indels_tagged.miptargets
experiment=$(basename $EXP_DIR)
crisprinfo=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/PB_indels_tagged.crispr
ptargs=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/miptargets/chrPLASMIDS.miptargets
pbcode=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/PB_indels_tagged.pbcode
gtargs=/data/talkowski/xander/MIPs/genomes/PB_indels_tagged/guides.miptargets
...
cd $FASTQ_DIR
bash $PROGRAM_DIR/set_up_demultiplexed_fastqs.sh $EXP_DIR/$barcodefile $EXP_DIR/$datadirfile
bash $PROGRAM_DIR/makejob_fastq_prep.sh $PEAR_IN_DIR $taglength
